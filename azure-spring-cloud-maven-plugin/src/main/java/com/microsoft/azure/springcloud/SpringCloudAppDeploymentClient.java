...
public class SpringCloudAppDeploymentClient extends SpringCloudClientBase {
    ...
    private final SpringCloudAppClient cloudAppClient;

    public static class Builder extends SpringCloudClientBase.Builder<Builder> {
        ...
        public SpringCloudAppDeploymentClient build() {
            return new SpringCloudAppDeploymentClient(this);
        }
    ...
    public SpringCloudAppDeploymentClient(Builder builder) {
        super(builder);
    ...
    public SpringCloudAppDeploymentClient(SpringCloudAppClient cloudAppClient, String deploymentName) {
    ...
    public DeploymentResourceInner createDeployment(SpringCloudAppDeploymentConfig deploymentConfig, ResourceUploadDefinitionInner resource) {
    ...
    public DeploymentResourceInner updateDeployment(DeploymentResourceInner deployment, SpringCloudAppDeploymentConfig deploymentConfig,
    ...
    private DeploymentResourceInner scaleDeployment(SpringCloudAppDeploymentConfig deploymentConfig) throws AzureExecutionException {
        final SkuInner skuInner = this.initDeploymentSku(deploymentConfig);
        final DeploymentSettings deploymentSettings = new DeploymentSettings()
    ...
    private SkuInner initDeploymentSku(SpringCloudAppDeploymentConfig deploymentConfig) {
    ...
    private static boolean isResourceScaled(SpringCloudAppDeploymentConfig deploymentConfig, DeploymentResourceInner deployment) {
