...
public class SpringCloudAppClient extends SpringCloudClientBase {
    ...
    public static class Builder extends SpringCloudClientBase.Builder<Builder> {
        ...
        @Override
        public SpringCloudAppClient build() {
            return new SpringCloudAppClient(this);
        }
    ...
    public SpringCloudAppClient(Builder builder) {
        super(builder);
        this.appName = builder.appName;
    }

    @Nonnull
    public AppResourceInner createOrUpdateApp(final AppResourceInner app, final SpringCloudAppConfig configuration) {
        return Objects.isNull(app) ? createApp(configuration) : updateApp(app, configuration);
    }

    @Nonnull
    public AppResourceInner createApp(final SpringCloudAppConfig configuration) {
    ...
    @Nonnull
    public AppResourceInner updateApp(final AppResourceInner app, final SpringCloudAppConfig configuration) {
    ...
    public SpringCloudAppDeploymentClient getDeploymentClient(String deploymentName, final AppResourceInner app) {
        ...
        return new SpringCloudAppDeploymentClient(this, deploymentName);
    }
    ...
    public static AppResourceProperties mergeConfigurationIntoProperties(SpringCloudAppConfig configuration, AppResourceProperties properties) {
    ...
    private static boolean isEnablePersistentStorage(SpringCloudAppConfig configuration) {
