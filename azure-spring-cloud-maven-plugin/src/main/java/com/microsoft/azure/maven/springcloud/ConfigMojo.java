...
public class ConfigMojo extends AbstractSpringMojo {
     ...
     */
    private SpringCloudAppConfig appSettings;

    /**
     * The deployment settings collected from user.
     */
    private SpringCloudAppDeploymentConfig deploymentSettings;
    ...
    protected void doExecute() throws MojoFailureException {
        ...
        appSettings = new SpringCloudAppConfig();
        deploymentSettings = new SpringCloudAppDeploymentConfig();
