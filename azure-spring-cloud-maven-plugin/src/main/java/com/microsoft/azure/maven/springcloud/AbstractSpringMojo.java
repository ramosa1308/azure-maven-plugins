...
import com.microsoft.azure.springcloud.exception.SpringConfigurationException;
import com.microsoft.azure.maven.springcloud.configuration.SpringConfigurationParser;
import com.microsoft.azure.maven.springcloud.configuration.SpringConfigurationParserFactory;
...
public abstract class AbstractSpringMojo extends AbstractMojo {
    ...
    protected SpringCloudAppDeploymentConfig deploymentConfig;
    ...
    public SpringCloudServiceClient getSpringServiceClient() {
        if (springServiceClient == null) {
            final LogLevel logLevel = getLog().isDebugEnabled() ? LogLevel.BODY_AND_HEADERS : LogLevel.NONE;
            springServiceClient = new SpringCloudServiceClient(azureTokenCredentials, subscriptionId, getUserAgent(), logLevel);
        }
