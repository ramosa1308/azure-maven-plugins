...
import com.microsoft.azure.maven.springcloud.prompt.PromptWrapper;
import com.microsoft.azure.springcloud.SpringCloudServiceClient;
...
@PrepareForTest({AzureAuthHelper.class, AppInsightHelper.class, TelemetryClient.class, ConfigMojo.class, AbstractSpringMojo.class, Azure.class,
    ServiceResourceInner.class, ProxyResource.class, SpringCloudServiceClient.class, PomXmlUpdater.class})
public class ConfigMojoTest {
    ...
    public void testSelectNoSubscription() throws Exception {
        ...
        final SpringCloudServiceClient mockServiceClient = mock(SpringCloudServiceClient.class);
        ...
        whenNew(SpringCloudServiceClient.class).withAnyArguments().thenReturn(mockServiceClient);
    ...
    public void testAcceptDefault() throws Exception {
        ...
        final SpringCloudAppConfig app = (SpringCloudAppConfig) FieldUtils.readField(mojo, "appSettings", true);
    ...
    public void testChildProject() throws Exception {
        ...
        mojo.execute();
        final SpringCloudAppConfig app = (SpringCloudAppConfig) FieldUtils.readField(mojo, "appSettings", true);
        final SpringCloudAppDeploymentConfig deploy = (SpringCloudAppDeploymentConfig) FieldUtils.readField(mojo, "deploymentSettings", true);
