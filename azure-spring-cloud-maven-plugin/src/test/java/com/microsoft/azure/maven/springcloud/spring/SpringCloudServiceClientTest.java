...
@PrepareForTest({SpringCloudServiceClient.class})
public class SpringCloudServiceClientTest {

    private SpringCloudServiceClient spyClient;

    @Before
    public void setUp() {
        final SpringCloudServiceClient springServiceClient = new SpringCloudServiceClient(new AzureTokenCredentials(null, null) {
            @Override
